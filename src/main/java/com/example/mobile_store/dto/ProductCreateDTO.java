...
public class ProductCreateDTO {
    ...
    public ProductCreateDTO(@NotBlank(message = "Product name is required") String productName, @NotBlank(message = "Item code is required") String itemcode, @NotBlank(message = "Description is required") String description, @NotBlank(message = "Manufacture is required") String manufacture, @NotBlank(message = "Category is required") String category, @NotNull(message = "Price is required") Double price, @NotNull(message = "Quantity is required") Integer quantity, @NotBlank(message = "Product condition is required") String productCondition) {
